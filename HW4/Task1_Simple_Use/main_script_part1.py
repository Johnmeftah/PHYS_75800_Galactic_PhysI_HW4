...
def main():
    ...
    # MOD (John): added M and eps to the folder name so runs don't overwrite each other.
...
# NOTE (John): the movie function didn't work for me, professor, will be using a different method to make animations.
